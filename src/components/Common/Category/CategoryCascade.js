  ...
  render() {
    ...
    return (
      <div>
        ...
        {(this.secondCategoryOptions.length > 0 || this.isShowAllCategory) &&
        ...
        {(this.thirdCategoryOptions.length > 0 || this.isShowAllCategory) &&
        ...
        {(this.fourCategoryOptions.length > 0 || this.isShowAllCategory) &&
