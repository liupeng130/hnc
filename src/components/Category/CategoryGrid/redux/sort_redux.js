...
function upLevel(keyArr,data,record,level) {
  ...
  if(level == 1){
    ...
    srcNode.key = keyArr[0]+ "-"+(srcKey - 1);
    var destNode = data[keyArr[0]].children[srcKey - 1];
    destNode.key = keyArr[0]+"-"+srcKey;
    ...
    srcNode.key = keyArr[0]+"-"+keyArr[1]+ "-"+(srcKey - 1);
    var destNode = data[keyArr[0]].children[keyArr[1]].children[srcKey - 1];
    destNode.key = keyArr[0]+"-"+keyArr[1]+"-"+srcKey;
    ...
    srcNode.key = keyArr[0]+"-"+keyArr[1]+"-"+keyArr[2]+ "-"+(srcKey - 1);
    var destNode = data[keyArr[0]].children[keyArr[1]].children[keyArr[2]].children[srcKey - 1];
    destNode.key = keyArr[0]+"-"+keyArr[1]+"-"+keyArr[2]+"-"+srcKey;
...
function top4Level(keyArr,data,record,level) {
  if(level == 1){
    ...
    //当前节点更新为第一个节点
    currentNode.key = keyArr[0]+"-"+keyArr[1]+ "-0";
    ...
    //当前节点更新为第一个节点
    currentNode.key = keyArr[0]+"-"+keyArr[1]+"-"+keyArr[2]+ "-0";
...
function exchangeNode(data,keyArr,curNode,nodeCount,nodeIndex,level) {
  if(level == 1){
    ...
    curNode.key = keyArr[0] + "-" + keyArr[1] + "-" + keyArr[2] + "-"+(nodeIndex + 1);
...
function bottom4Level(keyArr,data,record,level) {
  if(level == 1){
    ...
    //当前节点更新为最后节点
    currentNode.key = bottomNodeIndex+"";
    ...
    //当前节点更新为最后节点
    currentNode.key = keyArr[0]+"-"+keyArr[1]+"-"+keyArr[2]+ "-"+bottomNodeIndex;
    ...
    //当前节点更新为最后节点
    currentNode.key = keyArr[0]+"-"+keyArr[1]+ "-"+bottomNodeIndex;
