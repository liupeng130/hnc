...
import {SellGoodsEditBox} from 'components';
...
export default class SellGoodsEdit extends Component {
   ...
   */
  componentWillMount() {
    let itemId = this.props.location.query.itemId;
  ...
  createDom() {
    if(this.props.sellGoodsEdit.goodsData){
      ...
      // let goodsData = this.props.sellGoodsEdit.goodsData.data;
      // this.skuList = this.props.sellGoodsEdit.goodsData.data.itemSkuInfoList;
